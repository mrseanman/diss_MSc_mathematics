...
In previous sections we gave constructions that formed spaces from posets, we now give a construction in the opposite direction. Given a CW--complex $X$ denote the set of open cells as $X^*$. Given some $\sigma \in X^*$, denote its closure by $\overline{\sigma}$.
