...
\begin{definition}
	...
	Given some finite--height edge labelled poset $(P,\,\leq,\,l \colon \mathcal{E}(P) \to A)$, define the \emph{poset group} $G(P)$ to be the group generated by $A$ with relations equating words corresponding to saturated chains in the Hasse diagram of $P$ which start and end at the same vertices.
\end{definition}
