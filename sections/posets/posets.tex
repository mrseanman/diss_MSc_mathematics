...
\begin{definition}
	We define an \emph{edge labelled poset} to be a triple $(P,\leq,l)$ where $(P,\leq)$ is a poset and the function $l: \mathcal{E}(P) \to A$ a labelling of covering relations with alphabet $A$.
\end{definition}
...
A \emph{word corresponding to a saturated chain} is the word of the labels traversed in the Hasse diagram while tracing out that saturated chain.
\begin{definition}
