...
\begin{lemma}[{\hspace{1sp}\cite[Lemma 5.1]{paolini_salvetti_kpi1_2021}}]
    Fix a Coxeter system $(W,S)$ with set of reflections $R \subseteq W$ and let $l_R \colon W \to \N$ be the length function on $W$ with respect to the generating set $R$. For any Coxeter element $w \in W$, we have $l_R(w) = \Abs{S}$.
