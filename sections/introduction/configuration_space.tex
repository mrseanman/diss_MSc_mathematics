...
Here we will give the definition of the configuration space $Y_W$ for a given Coxeter group $W$ and go through an example where we will show that $\pi_1(Y_W) \cong G_W$ for $W$ of type $A_n$ \cite{fox_braid_1962}.
